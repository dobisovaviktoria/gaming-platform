# Bandit Games - Gaming Platform

This is a meta repository for all the components needed to run the gaming platform.
...
The platform follows the high-level structure:

1. **Frontend** – React/TypeScript app that connects with the backend and AI services.
2. **Backend** – Java based service handling APIs, game state, and server logic.
3. **AI Features** – Python notebooks and scripts for ML/AI integrations and experiments.
